...
~~~sh
# getting the code
git clone git@github.com:nko5/barcelonajs.git && cd ./barcelonajs/
...
# deploying to Modulus (to http://barcelonajs.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/barcelonajs" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
