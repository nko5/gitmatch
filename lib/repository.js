...
repository.checkRepo = function(repo) {
  var promiseContribuingMd = repository.checkContributingmd(repo);
  var promisePackageJson = repository.getPackageJson(repo);

  return Promise.all([promiseContribuingMd, promisePackageJson]);
};
